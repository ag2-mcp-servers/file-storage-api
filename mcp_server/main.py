...
from models import (
    ...
    FilesSearch,
    FilesSort,
    FileStorageUploadSessionsIdFinishPostRequest,
...
def drive_groups_all(
    ...
    filter: Optional[DriveGroupsFilter] = None,
...
def drives_all(
    ...
    cursor: Optional[str] = None,
    limit: Optional[conint(ge=1, le=200)] = 20,
    filter: Optional[DrivesFilter] = None,
    fields: Optional[str] = None,
):
    """
    List Drives
...
@app.get(
    ...
    tags=['file_operations', 'drive_handling'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def files_all(
    ...
    cursor: Optional[str] = None,
    limit: Optional[conint(ge=1, le=200)] = 20,
    filter: Optional[FilesFilter] = None,
    sort: Optional[FilesSort] = None,
...
@app.post(
    ...
    tags=['file_operations', 'upload_session_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def files_upload(
    raw: Optional[bool] = False,
    x_apideck_metadata: CreateFileRequest = Header(..., alias='x-apideck-metadata'),
    x_apideck_consumer_id: str = Header(..., alias='x-apideck-consumer-id'),
    x_apideck_app_id: str = Header(..., alias='x-apideck-app-id'),
    x_apideck_service_id: Optional[str] = Header(None, alias='x-apideck-service-id'),
):
...
@app.post(
    ...
    tags=['folder_operations', 'drive_handling'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.delete(
    ...
    tags=['folder_operations', 'drive_group_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.post(
    ...
    tags=['upload_session_operations', 'file_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.delete(
    ...
    tags=['upload_session_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
def upload_sessions_upload(
    id: str,
    x_apideck_consumer_id: str = Header(..., alias='x-apideck-consumer-id'),
    x_apideck_app_id: str = Header(..., alias='x-apideck-app-id'),
    x_apideck_service_id: Optional[str] = Header(None, alias='x-apideck-service-id'),
    part_number: confloat(ge=0.0, le=10000.0) = ...,
...
def upload_sessions_finish(
    ...
    x_apideck_service_id: Optional[str] = Header(None, alias='x-apideck-service-id'),
    digest: Optional[str] = None,
    body: FileStorageUploadSessionsIdFinishPostRequest = None,
):
    """
